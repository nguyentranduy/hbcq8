...
import com.hbc.config.GoogleDriveConfig;
...
public class GoogleDriveManager {
    ...
    private final String FOLDER_ID = "1BOAzWaTFUxpnAtHTzK3FOs7oZHZj1-gk";
...
//        }
	...
	public String uploadFile(MultipartFile multipartFile, PermissionDetails permissionDetails) {
        if (multipartFile == null) return null;

        File file = new File();
        file.setParents(Collections.singletonList(FOLDER_ID));
        file.setName(System.currentTimeMillis() + "_" + multipartFile.getOriginalFilename());
