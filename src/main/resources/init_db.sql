...
CREATE TABLE `tournament_detail` (
  ...
  `point1_key` varchar(5) DEFAULT NULL,
  `point1_submit_time` timestamp DEFAULT NULL,
  ...
  `point2_key` varchar(5) DEFAULT NULL,
  `point2_submit_time` timestamp DEFAULT NULL,
  ...
  `point3_key` varchar(5) DEFAULT NULL,
  `point3_submit_time` timestamp DEFAULT NULL,
  ...
  `point4_key` varchar(5) DEFAULT NULL,
  `point4_submit_time` timestamp DEFAULT NULL,
  ...
  `point5_key` varchar(5) DEFAULT NULL,
  `point5_submit_time` timestamp DEFAULT NULL,
  `end_point_code` varchar(5) NOT NULL,
  `end_point_coor` varchar(255) DEFAULT NULL,
  `end_point_dist` float DEFAULT NULL,
  `end_point_time` timestamp DEFAULT NULL,
  `end_point_speed` float DEFAULT NULL,
  `end_point_key` varchar(5) DEFAULT NULL,
  ...
  CONSTRAINT `tournament_detail_ibfk_3` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
);
