...
CREATE TABLE `tournament_detail` (
  ...
  `point1_code` varchar(5) NOT NULL,
  ...
  `point2_code` varchar(5) NOT NULL,
  ...
  `point3_code` varchar(5) NOT NULL,
  ...
  `point4_code` varchar(5) NOT NULL,
  ...
  `point5_code` varchar(5) NOT NULL,
